...
export default function NewsSection() {
  ...
  const extractVideoId = useCallback((url: string | undefined | null): string | null => {
    ...
    try {
      // Pour LinkedIn, retourner null car on ne peut pas extraire d'ID utilisable
        ...
        <div className="max-w-4xl mx-auto">
          {activeTab === 'youtube' ? (
            <article className="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-100">
              {latestVideo ? (
                <>
                  {latestVideo.LienVideo?.includes('linkedin.com') ? (
                    <div className="aspect-video bg-gradient-to-br from-blue-600 to-blue-800 flex items-center justify-center cursor-pointer"
                         onClick={() => window.open(latestVideo.LienVideo, '_blank', 'noopener,noreferrer')}>
                      <div className="text-center">
                        <svg className="w-20 h-20 text-white mx-auto mb-4" fill="currentColor" viewBox="0 0 24 24">
                          <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
                        </svg>
                        <p className="text-white text-lg font-medium">Cliquez pour voir sur LinkedIn</p>
                        <div className="w-12 h-12 bg-white/20 rounded-full flex items-center justify-center mx-auto mt-4">
                    ...
                    <div className="aspect-video bg-gray-200 flex items-center justify-center">
                      <div className="text-center">
                        ...
                        <p className="text-gray-500">Format vidéo non supporté</p>
                      </div>
                    </div>
                  )}
